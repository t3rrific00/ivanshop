      ...
      <div class="row">
        ...
        <div class="column middle" style="background-color: #fff; padding-top: 10px">
          ...
          <div class="middle-form">
            <label style="font-weight: bold; width: 50%; float: left; text-align: left;">Fullname:</label>
            <label style="font-weight: bold; width: 50%; float: left; text-align: left;">Email Address:</label><br /><br />
            <label style="width: 50%; float: left; text-align: left"><?php echo $row['full_name'];?></label>
            <label name="emailaddress" style="width: 50%; float: left; text-align: left"><?php echo $row['email_address'];?></label><br /><br />
            <label style="font-weight: bold; width: 50%; float: left; text-align: left;">Birthdate:</label>
            <label style="font-weight: bold; width: 50%; float: left; text-align: left;">Gender:</label><br /><br />
            <label name="birthdate" style="width: 50%; float: left; text-align: left">
              <?php 
              $date = date_create($row['birth_date']);
              echo date_format($date, "F j, Y");
              ?>
            </label>
            <label name="gender" style="width: 50%; float: left; text-align: left"><?php echo $row['gender'];?></label><br /><br />
            <label style="font-weight: bold; width: 50%; float: left; text-align: left;">Phone Number:</label><br /><br />
            <label name="phonenumber" style="width: 50%; float: left; text-align: left"><?php echo $row['phone_number'];?></label><br />
          </div>
          <!--End My Profile Form-->
        </div>
        <div class="column right" style="background-color: #d5f3fe; padding-top: 10px; margin: 10px 0">
          ...
          <label style="display: block; width: 250px; font-size: 16px; color: #0f5298; margin: 0 0 0 15px; text-transform: uppercase; font-weight: bold; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
          ...
          <div class="wrapper-sidebar-right">
            <div class="sidebar">
              <ul>
                <li>
                  <a href="myprofile.php"><i class="fas fa-home"></i>Manage My Account</a>
                </li>
                <ul>
                  <li style="padding-left: 20px; font-size: 14px; background-color: #66d3fa;">
                    <a href="myprofile.php" style="color: #242424"><i class="fas fa-home"></i>My Profile</a>
                  </li>
                  <ul>
                    ...
                    <li style="padding-left: 40px; font-size: 12px">
                      <a href="changepassword.php"><i class="fas fa-home"></i>Change Password</a>
                    </li>
                  </ul>
